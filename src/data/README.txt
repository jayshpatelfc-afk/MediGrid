...
The repository also includes a clearly marked synthetic live-day extension for
28-Aug-2026, generated by scripts/generate_live_day_data.py. It adds hourly
HIS movement and lab activity plus a current bed snapshot so the prototype can
demonstrate an all-day command-center workflow. These rows are demonstration
data, not a live hospital feed, and the original challenge rows remain intact.
